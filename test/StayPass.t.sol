...
import { StayPass } from "../src/StayPass.sol";
...
contract StayPassTest is PRBTest, StdCheats {
    StayPass internal pass = new StayPass();
    ...
    function testWorld_ShouldPrintSelector() external view {
        console2.logBytes4(pass.world());
    }
    ...
    //         console2.log("alchemy key not found");
    //         return;
    //     }
    //     console2.log("found alchemy key");
    ...
    //     console2.logUint(actualBalance);
